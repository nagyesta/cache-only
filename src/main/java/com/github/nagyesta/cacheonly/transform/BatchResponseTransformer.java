...
/**
 * Defines the behavior of response transformation between partial and batch responses.
 *
...
public interface BatchResponseTransformer<B, P, I> {
     ...
     * @return A map of the partial response using the request ID to identify them.
     */
     ...
     */
    @Nullable B mergeToBatchResponse(Map<I, P> entityMap);
